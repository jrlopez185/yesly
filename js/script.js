...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    setTimeout(function() {
        ...
        document.getElementById('happyMBcontainer5').style.display = 'block';
    }, 4000);
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = '¿Si?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 5:
            ...
            document.getElementById('noBtn').innerHTML = 'Solo piensa en ello, tu del barselona<p> y yo del madrid';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 6:
            ...
            document.getElementById('noBtn').innerHTML = 'Los polos opuestos se atraen';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
