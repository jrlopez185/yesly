/*function cambiar(){
    document.getElementById("cj-1").innerHTML = "Cristopher" , "jana"; 
}
...
document.getElementById("cj-1").innerHTML = user[posicion][1];
...
document.getElementById("pr-2").onclick = function (){
    mover_izquierda();
}